...
- **Compatibility with DwC-DP.** By building directly on the DwC-DP tables, existing datasets can be immediately queried semantically, without requiring changes to the original data format.
